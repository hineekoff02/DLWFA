...
from model import EventPositionModel
...
CONFIG = {
    ...
    "checkpoint_folder": "/vols/cms/hin21/delight/waveforms/trial4",  # Folder to save checkpoints
    "loss_folder": "/vols/cms/hin21/delight/waveforms/trial4/loss_data",          # Folder to save loss data and plot
    "start_checkpoint": None,            # Path to a checkpoint to resume from (or None)
    "batch_size": 64,                   # Batch size for training (events per batch)
...
if __name__ == "__main__":
    ...
    # Load datasets
    train_dataset = LazyHDF5Dataset(train_data_folder, trace_type=trace_type, use_fourier=use_fourier)
    val_dataset = LazyHDF5Dataset(val_data_folder, trace_type=trace_type, use_fourier=use_fourier)
    ...
    model = EventPositionModel().to(device)
